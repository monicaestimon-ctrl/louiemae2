...
605 W 9th Street, Unit #4063<br>Austin, TX 78701<br>{% unsubscribe 'Unsubscribe' %}</td></tr></table><!--[if mso]></td></tr></table><![endif]-->`;
  ...
  previews.push(`<section><header><strong>DRAFT ${index + 1} · DAY ${email.day}</strong><h2>${escape(email.subject)}</h2><p>${escape(email.preview)}</p></header>${content.replace("{% unsubscribe 'Unsubscribe' %}", 'Unsubscribe')}</section>`);
}
