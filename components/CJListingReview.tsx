...
export function CJListingReview({ value, context, variants, availableImages, onChange, productId, newListing = false, onBusyChange, revision }: {
    ...
    revision?: number; newListing?: boolean; onBusyChange?: (busy: boolean) => void;
}) {
