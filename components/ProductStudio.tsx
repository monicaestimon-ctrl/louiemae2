            ...
            if (result.source === '1688') {
                ...
                if (item) {
                    ...
                    scrapedData = {
                        ...
                        rawHtmlDescription: fields.rawHtmlDescription || (result as any).rawHtmlDescription || '',
                        rawSourceDescription: (result as any).rawDescription || fields.description || '',
                        descriptionImages: (result as any).descriptionImages || [],
            ...
            if (autoEnhance) {
                ...
                try {
                    const sourceSnapshot = buildSourceProductSnapshot({
                        ...
                        rawDescription: (updatedProduct as any).rawSourceDescription || updatedProduct.description,
                        htmlDescription: (updatedProduct as any).rawHtmlDescription || '',
                        price: Number(updatedProduct.price),
                        currency: 'USD',
                        images: updatedProduct.images || [],
                        descriptionImages: (updatedProduct as any).descriptionImages || [],
